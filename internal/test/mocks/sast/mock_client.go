...
// Source: github.com/checkmarxDev/ast-sast-export/internal/sast (interfaces: Client)

// Package sast is a generated GoMock package.
package sast
...
func (m *MockClient) GetProjectsWithLastScanID(arg0 string, arg1, arg2 int) (*[]sast.ProjectWithLastScanID, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetProjectsWithLastScanID", arg0, arg1, arg2)
	ret0, _ := ret[0].(*[]sast.ProjectWithLastScanID)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockClient) GetTriagedResultsByScanID(arg0 int) (*[]sast.TriagedScanResult, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetTriagedResultsByScanID", arg0)
	ret0, _ := ret[0].(*[]sast.TriagedScanResult)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
